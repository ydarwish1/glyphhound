"""Stage 5 -- Report data model + CI exit-code policy (ARCHITECTURE.md section 5).
...
class ReportSummary:
    """Counts that explain a :class:`Report` at a glance (ARCHITECTURE.md section 5)."""
...
@dataclass(frozen=True)
class Report:
    """The output of Stage 5: ``{findings, summary, exit_code}`` (ARCHITECTURE.md section 5)."""
