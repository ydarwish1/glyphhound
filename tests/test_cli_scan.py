...
The headline (ARCHITECTURE.md section 7 payoff): a sink hidden in a *named* template variant is
...
def test_local_gguf_named_template_is_caught_and_tagged(tmp_path):
    """The section 7 payoff: a benign default but a malicious NAMED template -> caught + tagged."""
